...
months in, I've been happy with the decision. There have been times
where it took a while to figure stuff out, but the code comes
with a lot of examples, and Bill has been helpful with questions on the
CCRMA CM Dist mailing list. 
